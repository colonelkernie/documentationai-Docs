...
3. **Select the Route Type** — choose the appropriate route type (Solo 1, Solo 2, Solo 5, RLB, or MAINT). The fields required to complete scheduling will vary based on the route type (see below).
