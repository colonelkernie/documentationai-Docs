...
A driver can have a second Shift Start Time window as well. Dynamic Scheduler will assign them a route whose start time falls in either window. See [Shift Start Time Windows](/help-center/solutions/shift-start-time-windows) for details.
